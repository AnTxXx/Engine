...
//TODO: Save Load statt room eventuell gamearea bei objects??

let eventHandler:AGEventHandler = new AGEventHandler();
let area:AGGameArea = new AGGameArea("ebene", new Vector3(30,2.5,10), eventHandler);
let room_1:AGRoom = area.newRoom("Erster Raum", new Vector3(10.0, 2.5, 10.0), new Vector3(0.0, 0.0, 0.0));


let gegner:AGObject = new AGObject("gegner", new Vector3(2,1,8), new Vector3(1,0,0), new Vector3(1,1,1), room_1);
...
let player:AGPlayer = new AGPlayer("spieler", new Vector3(8.0, 1.0, 5.0), new Vector3(1,0,0), new Vector3(1,1,1), controls, room_1);
let player_hit:AGSoundSource = new AGSoundSource("hit", "sounds/ouch.mp3", false, 1, room_1);
let door1:AGPortal = new AGPortal("Tuere 1", new Vector3(5.0, 1.0, 5.0), new Vector3(1,0,0), new Vector3(1,1,1), room_1);
let door2:AGPortal = new AGPortal("Tuere 2", new Vector3(3.0, 1.0, 3.0), new Vector3(1,0,0), new Vector3(1,1,1), room_1);
