...
export class AGObject {
    ...
    clearDeathSound() {
        ...
        let index = this._AGSoundSources.indexOf(this._deathSound);
    ...
    clearAliveSound() {
        ...
        let index = this._AGSoundSources.indexOf(this._aliveSound);
    ...
    clearInteractionSound() {
        ...
        let index = this._AGSoundSources.indexOf(this._interactionSound);
    ...
    get interactionCooldown() {
        return this._interactionCooldown;
    }

    set interactionCooldown(value) {
