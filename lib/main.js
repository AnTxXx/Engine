...
let gegner = new AGObject("gegner", new Vector3(0, 1, 0), new Vector3(1, 0, 0));
...
let player = new AGPlayer("spieler", new Vector3(0.0, 1.0, 0.0), new Vector3(1, 0, 0), new Vector3(1, 1, 1), controls);
