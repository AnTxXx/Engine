...
let waterFall = new AGObject("Waterfall", new Vector3(8.7, 1, 0.5), new Vector3(1, 0, 0), new Vector3(1, 1, 1));
...
let magic = new AGSoundSource("Magic", "sounds/steps.wav", true, 1, room_1ID);
let waterfall = new AGSoundSource("Waterfall", "sounds/ouch.mp3", false, 1, room_1ID);
