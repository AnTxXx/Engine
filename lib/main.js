...
let gegner_ss = new AGSoundSource("schritte", "sounds/steps.wav", true, 1, area);
let controls = new AGNavigation(38, 40, 37, 39);
let player = new AGPlayer("spieler", new Vector3(5.0, 1.0, 5.0), new Vector3(1, 0, 0), new Vector3(1, 1, 1), controls);
let player_hit = new AGSoundSource("hit", "sounds/ouch.mp3", false, 1, area);
...
let wallSOUTH = new AGObject("wall_south", new Vector3(5, 1, 10), new Vector3(1, 0, 0), new Vector3(5, 1, 1));
