...
let waterFall_1 = new AGObject("Waterfall", new Vector3(8.7, 1, 0.5), new Vector3(1, 0, 0), new Vector3(1, 1, 1));
let waterFall_2 = new AGObject("Waterfall", new Vector3(4.5, 1, 4.5), new Vector3(1, 0, 0), new Vector3(1, 1, 1));
let waterFall_3 = new AGObject("Waterfall", new Vector3(8, 1, 9.3), new Vector3(1, 0, 0), new Vector3(1, 1, 1));
let waterFall_4 = new AGObject("Waterfall", new Vector3(11, 1, 5.0), new Vector3(1, 0, 0), new Vector3(1, 1, 1));
...
let magic = new AGSoundSource("Magic", "sounds/magic.mp3", true, 1, room_1ID);
let waterfall_1 = new AGSoundSource("Waterfall", "sounds/waterfall.mp3", true, 1, room_1ID);
let waterfall_2 = new AGSoundSource("Waterfall", "sounds/waterfall.mp3", true, 1, room_1ID);
let waterfall_3 = new AGSoundSource("Waterfall", "sounds/waterfall.mp3", true, 1, room_1ID);
let waterfall_4 = new AGSoundSource("Waterfall", "sounds/waterfall.mp3", true, 1, room_1ID);
...
let magicID = getIdByReference(magic);
