...
let player = new AGPlayer("spieler", new Vector3(2.0, 1.0, 2.0), new Vector3(1, 0, 0), new Vector3(1, 1, 1), controls);
let door1 = new AGPortal("Tuere 1", new Vector3(2.0, 1.0, 2.0), new Vector3(1, 0, 0), new Vector3(1, 1, 1));
let door2 = new AGPortal("Tuere 1", new Vector3(8.0, 1.0, 8.0), new Vector3(1, 0, 0), new Vector3(1, 1, 1));
