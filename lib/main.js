...
let gegner = new AGObject("gegner", new Vector3(2, 1, 8), new Vector3(1, 0, 0), new Vector3(1, 1, 1), room_1);
let gegner_ss = new AGSoundSource("schritte", "sounds/steps.wav", true, 1, room_1);
let controls = new AGNavigation(38, 40, 37, 39, 32);
let player = new AGPlayer("spieler", new Vector3(8.0, 1.0, 5.0), new Vector3(1, 0, 0), new Vector3(1, 1, 1), controls, room_1);
let player_hit = new AGSoundSource("hit", "sounds/ouch.mp3", false, 1, room_1);
let door1 = new AGPortal("Tuere 1", new Vector3(5.0, 1.0, 5.0), new Vector3(1, 0, 0), new Vector3(1, 1, 1), room_1);
let door2 = new AGPortal("Tuere 2", new Vector3(3.0, 1.0, 3.0), new Vector3(1, 0, 0), new Vector3(1, 1, 1), room_1);
