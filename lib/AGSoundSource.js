...
/*extends AGObject*/ {
     ...
     */
    constructor(name, file, looping, interval, roomID) {
    ...
    playOnceAtPosition(pos) {
        console.log("[AGSoundSource] Playing AGSoundSource [ID: " + this._ID + "]: " + this._name + " at position " + pos.x + "/" + pos.y + "/" + pos.z + ".");
        this.stop();
