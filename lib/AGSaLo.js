...
export class AGSaLo {
    ...
    rebuild(lvl) {
        ...
        console.log("[AGSaLo] Start rebuilding. Loading Toggle ENABLED.");
        setLoading(true);
        for (let i = 0; i < parsedObject.length; i++) {
            ...
            if (obj._func === obj._fclass) {
                ...
                let applyFunc = getFunction(obj._fclass, obj._func, this._classes);
        ...
        setLoading(false);
        console.log("[AGSaLo] Rebuilding finished Loading Toggle DISABLED.");
...
function getFunction(classname, funct, obj) {
    let returnFunc = null;
